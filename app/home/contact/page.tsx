    ...
    <div>
      ...
      <main className='min-h-max grid grid-cols-1 lg:grid-cols-1 p-10 lg:p-8'>
        <section className='lg:flex h-full flex-col items-center justify-center gap-y-5 bg-primary rounded-2xl'>
              <h1 className="text-4xl font-extrabold text-white sm:text-5xl mb-5 pt-10 justify-center text-center">
                Contáctanos
              </h1>
              <h2 className="mt-4 text-3xl text-white/90 justify-center text-center">
                ¡Estamos aquí para ayudarte!
              </h2>
              <h3 className="mt-4 text-xl text-white/70 text-center px-6 justify-center">
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-4xl h-96 mx-auto">
