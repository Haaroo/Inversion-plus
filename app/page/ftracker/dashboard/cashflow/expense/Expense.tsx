        ...
        <section className="w-1/3 h-screen bg-gray-200">
            ...
            <article className="w-full px-5">
                {expenses.map((product) => (
                    <article key={product.id} className="h-full border-2 bg-gray-100 rounded-lg mt-4">
                        <article className="py-3 px-4 border-l-4 border-red-400">
                            <section className="flex flex-col">
                                <section className="flex justify-between mb-3">
                                    <p className="leading-relaxed font-medium text-lg">{product.description}</p>
                                ...
                                <section className="flex justify-between mt-2">
                                    ...
                                    <h1 className="text-lg font-medium text-red-500">${product.amount}</h1>
                                </section>
                            </section>
                        </article>
                    </article>
